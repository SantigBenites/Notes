...
A quorum in this case represents $2f$ messages for $f$ faults. Therefore it is necessary for value x to pass the prepare phase, for $2f+1$ processes to send to prepare(x)
